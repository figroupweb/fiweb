            ...
            >
                ...
                <Popover.Group className="hidden lg:flex lg:gap-x-12">
                    <Popover className="relative">
                        <Popover.Button className="flex items-center gap-x-1 text-sm uppercase font-semibold leading-6 text-gray-900">
                            Services
                            <ChevronDownIcon
                    ...
                    <div className="flex items-center justify-between">
                        <a href="#" className="-m-1.5 p-1.5">
                            ...
                            <Image
                                ...
                                width="103"
                                height="72"
                                src="https://res.cloudinary.com/duzbhhs72/image/upload/v1709561477/FI_Group_zrliai.png"
                                alt="image"
                            />
                        </a>
                        <button
