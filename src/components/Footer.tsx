    ...
    return (
        <footer className="bg-fi-100 dark:bg-slate-400 border-t border-slate-100">
            <div className="w-full pl-12 md:flex md:items-center md:justify-between lg:pl-8">
                ...
                <div className="md:order-1 flex flex-row justify-start items-center gap-x-8 w-full">
                    <div className="h-14 w-32 flex items-center justify-center">
                        <Logo hSize={6} mode="dark" />
                    </div>

                    <div className="flex flex-col gap-y-1">
                        <p
                            className={`text-center text-sm leading-6 text-gray-50 ${inter.className}`}
                        >
                        ...
                        <div className="flex flex-row justify-start items-center gap-x-4">
                            <a
                                href="#"
                                className={`text-gray-400 hover:text-gray-500 ${inter.className} text-xs`}
                            >
                                Privacy
                            </a>
                            <a
